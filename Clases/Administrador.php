...
public function editarMecánico($id, $nombre, $documento, $especialidad) {
   ...
   $conexion = new conexion();
        ...
        public function crearEspecialidad($specialty) {
            $conexion = new conexion();


            $specialty
 = mysqli_real_escape_string($this->conexion, $specialty);
            $query = "INSERT INTO specialty (nombre) VALUES ('$specialty
')";
            $resultado = mysqli_query($this->conexion, $query);
        ...
        public function editarEspecialidad($idEspecialidad, $nuevoNombre) {
            ...
            $query = "UPDATE specialty SET nombre='$nuevoNombre' WHERE id=$idEspecialidad";
